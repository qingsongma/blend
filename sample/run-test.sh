...
# Computing blend scores given to the test file
echo -e "DONE\nStarting to generate test feat file..."
sh $dir/scripts/testFeast.sh $tst "${metrics[*]}" $testf
echo -e "DONE\nStaring predicting..."
sh $dir/scripts/predict.sh $trainf $testf $dir
echo "DONE"
